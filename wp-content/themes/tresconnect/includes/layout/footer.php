  ...
  <div class="footer__top">
    <div class="container">
      <div class="footer__topBoxWrapper">
        <div class="footer__topBox footer__topBox--40 footer__topBox--vcenter">
          <img src="<?= get_field('footer_logo', 'option')['sizes']['large']; ?>" alt="Logo - footer">
        </div>
        <div class="footer__topBox footer__topBox--30">
          <?= get_field('footer_contact_data', 'option'); ?>
        </div>
        <div class="footer__topBox footer__topBox--30">
          <?= get_field('footer_information', 'option'); ?>
        </div>
        <div class="footer__topBox footer__topBox--30 footer--desktopHidden">
          <h4>Social media</h4>
